...
| A2 | **明文密碼暴露** | `SASS_CHECKPOINT.md` §G (L742-746) | saki/[REDACTED_PWD], admin: [USER]/[REDACTED_PWD], 內網 IP | `git rm --cached` |
...
| # | 檔案 | 敏感內容 | 脫敏方法 |
|---|------|----------|----------|
| C1 | `Scientia/20260303_2045_SakiAgentSSH_首次成功部署_Scientia.md` | `allowed_cidrs: ["[REDACTED_CIDR]", "100.64.0.0/10"]`、LAN IP | 替換為 `[REDACTED_CIDR]` |
| C2 | `Scientia/20260303_1118_機構匯流排完整情報與理想架構_Scientia.md` | 大量內網 IP（[INTERNAL_SUBNET].x）、設備完整布局 | **建議移至 B 級**（內容幾乎全是內網架構） |
