...
- **Windows**：
  - Daemon: `https://github.com/Saki-tw/SakiAgentSSH/releases/download/v1.4.0/sakisshd.exe`
  - Client: `https://github.com/Saki-tw/SakiAgentSSH/releases/download/v1.4.0/sakissh.exe`
