...
namespace SakiSshDaemon.Interop
{
    ...
    public static class NativeMethods
    {
        ...
        // RFC 參考: draft-sakistudio-sass-07 Appendix C.1
        // =====================================================================
        ...
        // RFC 參考: draft-sakistudio-sass-07 Appendix C.2
        // =====================================================================

        /// <summary>
        /// 從 TLS session 推導 Exported Keying Material (EKM)。
        /// Label = "EXPORTER-sakissh-chacha20-v15"，Length = 44 bytes。
        /// </summary>
        ...
        // 對應 Rust: audit.rs
        // RFC 參考: draft-sakistudio-sass-07 Appendix C.4
        // =====================================================================
